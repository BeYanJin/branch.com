...
.directive('loginForm', [ function () {
    return {
        restrict: 'E',
        templateUrl: 'pages/login/templates/login-form.html'
    };
}])
// 注册表单组件
.directive('registerForm', [ function () {
    return {
        restrict: 'E',
        templateUrl: 'pages/login/templates/register-form.html'
    };
}])
// 注册表单组件
.directive('registerPopupForm', [ function () {
    return {
        restrict: 'E',
        templateUrl: 'pages/login/templates/register-popup-form.html'
    };
}]);
